 ...
 * @描述： 故障数据
 */
public class FaultDataFragment extends BaseFragment {

    @BindView(R.id.f_d_recyclerview)
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = getInflater(getContext(), R.layout.act_fault_data_fragment, container, false);
