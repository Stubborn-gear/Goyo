package com.htdata.goyo.main.make.fragment;
...
import com.htdata.goyo.main.make.adapter.DeviceSetsAdapter;
...
public class DeviceAllFragment extends BaseFragment {
    ...
    private DeviceSetsAdapter myAdapter;
    ...
    private void initRecyclerview() {
        ...
        myAdapter = new DeviceSetsAdapter(getMyContext(),getActivity(),getList());
